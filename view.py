...
if __name__=="__main__":
    ...
    label=Label(root,text="Voter IF Details",font="bold",fg="Red")
    ...
    borrow_label=Label(root,text="Voter ID")
    borrow_label2=Label(root,text="ID No")
    borrow_label3=Label(root,text="Age")
    borrow_label4=Label(root,text="Phone")
    borrow_label5=Label(root,text="Consitency")
